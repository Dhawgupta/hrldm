...
def main():
    ...
    agent = DQNAgent(state_size=CONTROLLER_STATE_SIZE ,action_size= CONTROLLER_ACTION_SIZE, hiddenLayers=[75], dropout = 0.000, activation = 'relu',loadname = None, saveIn = False, learningRate=0.05, discountFactor= 0.9 )
    ...
    for episode in range(EPISODES):
        ...
        while not done:  # The Loop i whcih meta policy acts
            ...
            #state = np.concatenate([confidence_state, goal_])
            ...
            next_state=next_confidence_state
