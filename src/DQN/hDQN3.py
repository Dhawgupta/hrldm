"""
Changes from hDQN_mulit, and hDQN:
1. This meant to separate the controller level policy for each intent
2. Implmementing this for a single intent only as of now so this will be trained by a train for controller level policy
TODO Not complete, first I will be working on train_individual_intetn_multiple_models
"""
import random
import numpy as np
...
class hDQN3:
    '''
    This meant to work  by creating a separate controller policy for each option
    '''
    ...
    def loadMetaPolicy(self,
                       name):  # TODO differentiate between the loading of the meta polciy and the controller polci
